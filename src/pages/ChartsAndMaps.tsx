...
const ChartsAndMaps: React.FC = () => {
  const {
    ...
    error: worldError,
  } = useQuery<WorldwideData, Error>("worldData", fetchWorldwideData);
  const {
    data: countryData,
  ...
  } = useQuery<HistoricalData, Error>("historicalData", fetchHistoricalData);
                ...
                <Marker
                  ...
                  <Popup>
                    <div className="text-sm">
                      ...
                      <p>
                        <span className="font-semibold">Total Deaths:</span>{" "}
                        {country.deaths.toLocaleString()}
                      </p>
                      <p>
                        <span className="font-semibold">Total Recovered:</span>{" "}
